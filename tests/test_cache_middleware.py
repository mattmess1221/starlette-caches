...
@pytest.mark.asyncio
async def test_response_auto_invalidation() -> None:
    from .examples.invalidation import routes
...
@pytest.mark.asyncio
async def test_response_manual_invalidation() -> None:
    from .examples.invalidation import routes
    ...
    async with client:
        ...
        r = await client.post("/invalidate")
...
@pytest.mark.asyncio
async def test_response_invalidation_noop() -> None:
    from .examples.invalidation import routes
